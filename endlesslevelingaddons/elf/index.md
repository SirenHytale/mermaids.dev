---
title: Elf Race
description: Endless Leveling Addons - Elf Race
parent: Endless Leveling Addons
layout: page
permalink: /endless-leveling/elf/
nav_order: 2
---
...
flowchart TD;
    Elf["Elf<br/>Base"];
    Elf --> Windrunner["Windrunner<br/>Tier 1 - Ranger"];
    Elf --> Grovewarden["Grovewarden<br/>Tier 1 - Grove"];

    Windrunner --> Shadowstrike["Shadowstrike<br/>Tier 2 - Ranger"];
    Grovewarden --> Moonweaver["Moonweaver<br/>Tier 2 - Grove"];

    Shadowstrike --> Starweaver["Starweaver<br/>Final - Hybrid"];
    Moonweaver --> Starweaver;
```
